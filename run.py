...
_PATH_DOC_LANG = {"CH": "fr", "DE": "de", "FR": "fr", "NL": "nl"}
_PATH_DOC_FILE = {"CH": "switzerland.md", "DE": "germany.md",
                  "FR": "france.md", "NL": "netherlands.md"}
_PATH_STEP_LABELS = {        # mirrors web/i18n.js PATH_STRINGS step labels
    ...
    # The Netherlands has no on-water practical exam for the klein vaarbewijs, so
    # `practical` never renders — the label is kept for symmetry only.
    "nl": {"age": "Minimumleeftijd", "medical": "Gezondheid & geschiktheid",
           "first_aid": "Eerste hulp", "practical": "Praktijkexamen",
           "application": "Aanvraag & inschrijving", "fees": "Examengeld",
           "validity": "Geldigheid & vernieuwing"},
}
_PATH_DOC_CHROME = {
    ...
    "nl": {"heading": "Van theorie naar vaarbewijs: de stappen naast het examen",
           "intro": "Het examen halen is niet genoeg. Deze stappen worden gegenereerd "
                    "uit `src/countries/{mod}.py` (veld `path`) — elk feit komt uit "
                    "een officiële bron en is gedateerd.",
           "step": "Stap", "detail": "Detail", "scope": "Bereik",
           "source": "Bron", "verified": "gecontroleerd op",
           "volatile": "(kan wijzigen)"},
}
