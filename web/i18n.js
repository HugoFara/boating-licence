...
const READING_STRINGS = {
  fr: {
    ...
    learnWhere: "Où apprendre",
    learnWhereIntro: "Le programme officiel, la loi, les catalogues et guides — et, signalés comme tels, quelques manuels payants (ni recommandation ni affiliation). Chaque entrée a été vérifiée à la date indiquée ; la couverture est calculée sur les questions de ce lot.",
    learnByTheme: "Thème par thème",
    learnCovers: "couvre {pct} % des questions (par thème)",
    learnCited: "cité par {pct} % des questions",
    learnThemes: "Thèmes :",
    learnBasis_programme: "c'est le programme officiel lui-même",
    learnBasis_toc: "d'après sa table des matières",
    learnBasis_publisher: "d'après l'éditeur (table des matières non consultée)",
    learnBasis_units: "d'après les articles ingérés",
    learnOfficial: "officiel",
    learnFree: "gratuit",
    learnPaid: "payant",
    learnKind_programme: "programme",
    learnKind_law: "texte de loi",
    learnKind_catalogue: "catalogue officiel",
    learnKind_sample_exam: "examen d'exemple",
    learnKind_guide: "guide",
    learnKind_handbook: "manuel",
    learnCoversPoints: "couvre {pct} % des points du programme officiel",
    learnBankCovers: "Ce lot contient des questions pour {got} des {total} points du programme officiel ({pct} %).",
    learnBankMissing: "Pas encore de questions : {themes}.",
    cfgSlotScale: "{min} à {max} pts/question (matrice officielle)",
  ...
  de: {
    ...
    learnWhere: "Wo lernen",
    learnWhereIntro: "Das amtliche Programm, das Gesetz, Kataloge und Leitfäden — und, so gekennzeichnet, einige kostenpflichtige Lehrbücher (weder Empfehlung noch Verbindung). Jeder Eintrag wurde am angegebenen Datum geprüft; die Abdeckung ist über die Fragen dieses Pakets berechnet.",
    learnByTheme: "Thema für Thema",
    learnCovers: "deckt {pct} % der Fragen ab (nach Thema)",
    learnCited: "von {pct} % der Fragen zitiert",
    learnThemes: "Themen:",
    learnBasis_programme: "ist selbst das amtliche Programm",
    learnBasis_toc: "laut Inhaltsverzeichnis",
    learnBasis_publisher: "laut Verlag (Inhaltsverzeichnis nicht eingesehen)",
    learnBasis_units: "laut den ingestierten Artikeln",
    learnOfficial: "amtlich",
    learnFree: "kostenlos",
    learnPaid: "kostenpflichtig",
    learnKind_programme: "Programm",
    learnKind_law: "Gesetzestext",
    learnKind_catalogue: "amtlicher Katalog",
    learnKind_sample_exam: "Musterprüfung",
    learnKind_guide: "Leitfaden",
    learnKind_handbook: "Lehrbuch",
    learnCoversPoints: "deckt {pct} % der Punkte des amtlichen Programms ab",
    learnBankCovers: "Dieses Paket enthält Fragen für {got} von {total} Punkten des amtlichen Programms ({pct} %).",
    learnBankMissing: "Noch keine Fragen: {themes}.",
    cfgSlotScale: "{min} bis {max} Pkt./Frage (amtliche Matrix)",
  ...
  it: {
    ...
    learnWhere: "Dove studiare",
    learnWhereIntro: "Il programma ufficiale, la legge, i cataloghi e le guide — e, segnalati come tali, alcuni manuali a pagamento (né raccomandazione né affiliazione). Ogni voce è stata verificata alla data indicata; la copertura è calcolata sulle domande di questo pacchetto.",
    learnByTheme: "Tema per tema",
    learnCovers: "copre il {pct} % delle domande (per tema)",
    learnCited: "citato dal {pct} % delle domande",
    learnThemes: "Temi:",
    learnBasis_programme: "è il programma ufficiale stesso",
    learnBasis_toc: "secondo il suo indice",
    learnBasis_publisher: "secondo l'editore (indice non consultato)",
    learnBasis_units: "secondo gli articoli ingeriti",
    learnOfficial: "ufficiale",
    learnFree: "gratuito",
    learnPaid: "a pagamento",
    learnKind_programme: "programma",
    learnKind_law: "testo di legge",
    learnKind_catalogue: "catalogo ufficiale",
    learnKind_sample_exam: "esame di prova",
    learnKind_guide: "guida",
    learnKind_handbook: "manuale",
    learnCoversPoints: "copre il {pct} % dei punti del programma ufficiale",
    learnBankCovers: "Questo pacchetto contiene domande per {got} dei {total} punti del programma ufficiale ({pct} %).",
    learnBankMissing: "Ancora nessuna domanda: {themes}.",
    cfgSlotScale: "da {min} a {max} pt/domanda (matrice ufficiale)",
  ...
  en: {
    ...
    learnWhere: "Where to study",
    learnWhereIntro: "The official programme, the law, catalogues and guides — and, flagged as such, a few paid handbooks (neither recommendation nor affiliation). Each entry was verified on the date shown; coverage is computed over this bundle's questions.",
    learnByTheme: "Theme by theme",
    learnCovers: "covers {pct}% of the questions (by theme)",
    learnCited: "cited by {pct}% of the questions",
    learnThemes: "Themes:",
    learnBasis_programme: "it is the official programme itself",
    learnBasis_toc: "per its table of contents",
    learnBasis_publisher: "per the publisher (table of contents not seen)",
    learnBasis_units: "per the ingested articles",
    learnOfficial: "official",
    learnFree: "free",
    learnPaid: "paid",
    learnKind_programme: "programme",
    learnKind_law: "statute",
    learnKind_catalogue: "official catalogue",
    learnKind_sample_exam: "sample exam",
    learnKind_guide: "guide",
    learnKind_handbook: "handbook",
    learnCoversPoints: "covers {pct}% of the official programme's points",
    learnBankCovers: "This bundle holds questions for {got} of the official programme's {total} points ({pct}%).",
    learnBankMissing: "No questions yet: {themes}.",
    cfgSlotScale: "{min} to {max} pts/question (official matrix)",
  ...
  nl: {
    ...
    learnWhere: "Waar leren",
    learnWhereIntro: "Het officiële programma, de wet, catalogi en gidsen — en, als zodanig gemarkeerd, enkele betaalde boeken (geen aanbeveling, geen band). Elke vermelding is op de genoemde datum gecontroleerd; de dekking is berekend over de vragen van deze bundel.",
    learnByTheme: "Thema voor thema",
    learnCovers: "dekt {pct} % van de vragen (per thema)",
    learnCited: "aangehaald door {pct} % van de vragen",
    learnThemes: "Thema's:",
    learnBasis_programme: "is zelf het officiële programma",
    learnBasis_toc: "volgens de inhoudsopgave",
    learnBasis_publisher: "volgens de uitgever (inhoudsopgave niet ingezien)",
    learnBasis_units: "volgens de ingelezen artikelen",
    learnOfficial: "officieel",
    learnFree: "gratis",
    learnPaid: "betaald",
    learnKind_programme: "programma",
    learnKind_law: "wettekst",
    learnKind_catalogue: "officiële catalogus",
    learnKind_sample_exam: "voorbeeldexamen",
    learnKind_guide: "gids",
    learnKind_handbook: "cursusboek",
    learnCoversPoints: "dekt {pct} % van de punten van het officiële programma",
    learnBankCovers: "Deze bundel bevat vragen voor {got} van de {total} punten van het officiële programma ({pct} %).",
    learnBankMissing: "Nog geen vragen: {themes}.",
    cfgSlotScale: "{min} tot {max} pt/vraag (officiële toetsmatrijs)",
    learnAsOf: "stand {date}",
  },
};
