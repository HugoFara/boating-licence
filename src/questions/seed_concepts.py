        ...
        "lang": {
            "fr": {
                ...
                "body": (
                    ...
                    "L'ordre n'est pas arbitraire, et c'est ce qui permet de le "
                    "reconstituer : en descendant l'échelle, le bateau devient plus "
                    "léger, plus maniable, plus court à arrêter. S'écarte donc celui "
                    "qui le peut le plus facilement. Un bateau à marchandises chargé "
                    "ne s'arrête pas en quelques longueurs ; un pêcheur "
                    "professionnel qui porte les signaux de l'art. 31 a ses filets à "
                    "l'eau — ces signaux ne se montrent que pendant la pose et le "
                    "relèvement ; un voilier ne tient aucune route face au vent ; une "
                    "planche à voile vire dans sa propre longueur, et se range donc "
                    "devant tout le monde. Seul le haut de l'échelle suit une autre "
                    "logique : la priorité des bateaux en service régulier est un "
                    "choix de service public — horaire et débarcadère fixes — et non "
                    "une question de manœuvrabilité.\n\n"
            ...
            "de": {
                ...
                "body": (
                    ...
                    "Die Reihenfolge ist nicht willkürlich, und genau deshalb lässt "
                    "sie sich herleiten: je weiter man die Leiter hinuntergeht, desto "
                    "leichter, wendiger und kürzer zu stoppen wird das Schiff. Es "
                    "weicht also aus, wer es am leichtesten kann. Ein beladenes "
                    "Güterschiff steht nicht in wenigen Schiffslängen; ein "
                    "Berufsfischer mit den Zeichen nach Art. 31 hat seine Netze im "
                    "Wasser — diese Zeichen werden nur während des Setzens und "
                    "Einholens geführt; ein Segelschiff hält gegen den Wind gar "
                    "keinen Kurs; ein Segelbrett dreht in seiner eigenen Länge und "
                    "weicht deshalb allen aus. Nur die Spitze der Leiter folgt einer "
                    "anderen Logik: der Vorrang der Kursschiffe ist eine Entscheidung "
                    "für den öffentlichen Verkehr — fester Fahrplan, feste "
                    "Anlegestelle — und keine Frage der Manövrierfähigkeit.\n\n"
            ...
            "it": {
                ...
                "body": (
                    ...
                    "cpv. 2).\n\n"
                    "L'ordine non è arbitrario, ed è proprio per questo che si può "
                    "ricostruire: scendendo la scala il battello diventa più "
                    "leggero, più manovriero, più corto da fermare. Si allontana "
                    "dunque chi può farlo più facilmente. Un battello carico di "
                    "merci non si ferma in poche lunghezze; un pescatore "
                    "professionista che porta i segnali dell'art. 31 ha le reti in "
                    "acqua — quei segnali si portano solo durante la posa e il "
                    "ritiro; un battello a vela controvento non tiene alcuna rotta; "
                    "una tavola a vela vira nella propria lunghezza e perciò cede il "
                    "passo a tutti. Solo la cima della scala segue un'altra logica: "
                    "la precedenza dei battelli in servizio regolare è una scelta di "
                    "servizio pubblico — orario e approdo fissi — e non una "
                    "questione di manovrabilità.\n\n"
            ...
            "en": {
                ...
                "body": (
                    ...
                    "boats (art. 44, para. 2).\n\n"
                    "The order is not arbitrary, which is exactly why it can be "
                    "reconstructed: the further down the ladder, the lighter, "
                    "handier and shorter to stop the boat becomes. So the one that "
                    "can most easily get out of the way is the one that does. A "
                    "loaded cargo boat does not stop in a few boat lengths; a "
                    "professional fisherman showing the art. 31 signals has nets in "
                    "the water — those signals are only shown while setting and "
                    "hauling; a sailing boat holds no course at all into the wind; a "
                    "sailboard turns in its own length, and therefore gives way to "
                    "everyone. Only the top of the ladder follows a different logic: "
                    "the priority of scheduled-service boats is a public-transport "
                    "decision — fixed timetable, fixed pier — not a question of "
                    "manoeuvrability.\n\n"
        ...
        "lang": {
            "en": {
                ...
                "body": (
                    ...
                    "That order never has to be memorised, because the Rule states "
                    "its criterion in the names of its own categories: \"not under "
                    "command\" and \"restricted in her ability to manoeuvre\" describe "
                    "how little choice a vessel has. The ladder runs from the vessel "
                    "that physically cannot get out of your way to the one that "
                    "easily can. Rule 18(d) closes it in the same key: every vessel "
                    "should avoid impeding one constrained by her draught, and that "
                    "vessel must herself navigate with particular caution — for her "
                    "the limit is the depth under the keel, not the water around "
                    "her.\n\n"
            ...
            "fr": {
                ...
                "body": (
                    ...
                    "(règle 18(e)).\n"
                    "Cet ordre n'est pas à apprendre par cœur : la règle énonce son "
                    "critère dans le nom même de ses catégories. « Qui n'est pas "
                    "maître de sa manœuvre » et « à capacité de manœuvre restreinte » "
                    "décrivent le peu de choix dont dispose un navire. L'échelle va "
                    "de celui qui ne PEUT physiquement pas s'écarter à celui qui le "
                    "peut sans effort. La règle 18(d) referme dans le même registre : "
                    "chacun évite de gêner un navire handicapé par son tirant d'eau, "
                    "lequel doit lui-même naviguer avec une prudence particulière — "
                    "pour lui, la contrainte est la hauteur d'eau sous la quille, pas "
                    "l'espace autour.\n\n"
